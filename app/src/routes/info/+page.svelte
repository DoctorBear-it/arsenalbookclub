<script lang="ts">
	...
	let resourcesList: Record<string, string>[] = [
		...
		{
			id: 'Example Repo',
			url: 'https://github.com/vercel/examples/tree/main/storage/postgres-sveltekit'
		},
		{ id: 'Example Repo', url: 'https://github.com/sveltejs/kit-template-default' },
		{
			id: 'Example Repo',
			url: 'https://github.com/nextauthjs/next-auth/tree/main/apps/examples/sveltekit'
		},
		{
			id: 'Example Repo',
			url: 'https://github.com/ivanhofer/sveltekit-typescript-showcase/tree/main'
		},
		{ id: 'Example Repo', url: 'https://vercel.com/templates/svelte' },
		{ id: 'Resource', url: 'https://scottspence.com/' },
		{
			id: 'Resource',
			url: 'https://www.sveltesociety.dev/recipes/component-recipes/using-fetch-to-consume-apis'
		},
		{ id: 'Resource', url: 'https://www.sveltesociety.dev/recipes' },
		{ id: 'Resource', url: 'https://www.sveltesociety.dev/packages' },
		{
			id: 'Code Examples',
			url: 'https://svelte.dev/repl/5c95e18702764aefa71ff2b4616a6c6e?version=3.20.1'
		},
		...
		{
			id: 'Code Examples',
			url: 'https://svelte.dev/repl/9fb792271c324da5bf1df6ccc617a902?version=3.29.7'
		},
...
<h1 class="dark:text-white">{JSON.stringify(data.item.message, null, 2)}</h1>
	...
	<TableBody tableBodyClass="divide-y">
		{#each $sortItems as item, i}
			<TableBodyRow on:click={() => toggleRow(i)}>
				...
				<TableBodyCell><a href={item.url}> {item.url}</a></TableBodyCell>
